...
### Added
- 「師傅看房」沉浸模式（`/story`）：用你的平面圖即時建成 3D 房子（three.js：地板、外牆、隔間、門窗、家具、九宮與流年星投影地板），風水師角色帶著鏡頭從門口進屋、逐間房間、屋頂看流年、財位文昌、總結，每章一段師傅口吻的解說、對話泡泡與該房間的待辦；翻頁、目錄、鍵盤左右鍵。師傅插畫放 `public/master.png` 即自動套用（目前為剪影佔位）。
